...
- **プルリクエスト**: リポジトリ別の PR サマリメトリクス
- **メンバーメトリクス**: ユーザー毎の利用状況（検索・ソート機能付き）

## 前提条件

- Node.js 18+
- npm
- 適切な権限を持つ GitHub Personal Access Token（下記参照）
...
- **Client Components**（チャート、テーブル）はデータを props として受け取り、インタラクティブな可視化を描画します。
